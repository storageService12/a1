...
// Session middleware
app.use(session({
    secret: 'DKercp6ySmErnClwYCOPl8VbkQJUboGiqJCdv8UPC-lMOWIlqFGCQe_488vXz_Yf', // Replace with a strong secret key
    resave: false,
...
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'frontenda.html'));
});
